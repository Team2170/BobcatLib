...
import BobcatLib.Hardware.Motors.FalconMotor;
...
public class FalconBasedSubsystem extends SubsystemBase {
  private BaseMotor mMotor;

  /** Creates a new NovaBasedSubsystem. */
  public FalconBasedSubsystem() {
    ...
    mMotor = new BaseMotor(new FalconMotor(canDevice, "rio", mc), limits);
  }
