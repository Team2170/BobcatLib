...
import BobcatLib.Hardware.Motors.ThriftyMotor;
...
public class NovaBasedSubsystem extends SubsystemBase {
  private BaseMotor mMotor;

  /** Creates a new NovaBasedSubsystem. */
  public NovaBasedSubsystem() {
    ...
    mMotor = new BaseMotor(new ThriftyMotor(canDevice, "rio", mc), limits);
  }
